...
BEGIN {
    ...
    require 'C:/Users/ricar/source/repos/btc-miner/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'C:/Users/ricar/source/repos/btc-miner/vcpkg_installed/vcpkg/blds/openssl/x64-windows-rel/test/fips-and-base.cnf';
    shift;
